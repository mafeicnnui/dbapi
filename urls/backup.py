...
from   service.backup   import read_config_backup,write_backup_status,write_backup_total,write_backup_detail,\
                               set_crontab_local,set_crontab_remote,push_script_remote,run_script_remote,stop_script_remote
