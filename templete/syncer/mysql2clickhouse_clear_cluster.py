...
def clear_ck_log(cfg):
    db = get_ds_ck_cluster(cfg)
    for ip in db['shards']:
        logging.info('truncate table system.query_thread_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.query_thread_log')

        logging.info('truncate table system.query_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.query_log')

        logging.info('truncate table system.part_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.part_log')

        logging.info('truncate table system.trace_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.trace_log')

        logging.info('truncate table system.asynchronous_metric_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.asynchronous_metric_log')

        logging.info('truncate table system.metric_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.metric_log')

        logging.info('truncate table system.session_log for sharding {}!'.format(ip))
        db['shards'][ip].execute('truncate table system.session_log')
